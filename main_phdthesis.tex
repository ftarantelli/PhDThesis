\documentclass[a4paper,pra,aps,longbibliography,preprintnumbers,amsmath,amssymb,nofootinbib,floatfix,titlepage,openany,10pt]{book}
...
%\geometry{a4paper,top=2.0cm,bottom=2.cm,left=1.8cm,right=1.8cm,%
%heightrounded,bindingoffset=5mm}
\geometry{a4paper,top=1.5cm,bottom=1.5cm,left=1.cm,right=1.cm,%
heightrounded,bindingoffset=5mm}
