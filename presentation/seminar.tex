...
\NewDocumentCommand{\reff}{s m}{%
  ...
  \title[PreThesis]{\textbf{Out-of-equilibrium dynamics in
round-trip and dissipation protocols} }
  \author[F.Tarantelli]{Francesco Tarantelli  \\ 
  \texttt{francesco.tarantelli@phd.unipi.it \\ \small
  Tarantelli, Vicari PR B \textbf{105}, 235124 (2022)\\
  Tarantelli, Vicari PR B \textbf{108}, 035128 (2023)\\ 
  Franchi, Tarantelli PR B \textbf{108}, 094114 (2023)\\
  Tarantelli, Scopa PR B \textbf{108}, 104316 (2023) }}
  \date[ ]{$17^{\rm th}$ October}
  \institute[unipi]{University of Pisa and INFN}
  \logo{\textcolor{white!50!red}{\small \texttt{PrePhD$_{\rm 2023}$}}}
...
%   \end{frame}
   ...
   \include{slides/transition}
   \include{slides/model}
   \include{slides/protocol}
   \include{slides/observables}
   \include{slides/dynamic_scaling}
   \include{slides/phase_anomaly}
   \include{slides/open}
